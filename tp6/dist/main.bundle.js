...
var MeteoService = /** @class */ (function () {
    ...
    MeteoService.prototype.getMeteo = function (name) {
        ...
        return fetch('https://demo.bilelz.fr/owmap/?q=' + name + '&units=metric&lang=fr&appid=b2d85d85a7073de91806e93da47af001')
    ...
    MeteoService.prototype.getMeteo2 = function (name) {
        console.log('from service', name);
        var m = new __WEBPACK_IMPORTED_MODULE_1__meteoItem__["a" /* MeteoItem */]();
        return fetch('https://demo.bilelz.fr/owmap/forecast/?q=popo&lang=fr&appid=0ada432b59deb9716c357092c5f79be6')
            .then(function (response) {
            return response.json();
        })
            .then(function (json) {
