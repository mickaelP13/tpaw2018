...
  console.log( "click" ); 
    ...
    if ($("#Nom").val().length>4 && $("#prenom").val().length>4 && $("#mail").val().length>4 && $("#adresse").val().length>4 ){
     ...
     $(".modal-body").html('<a href="http://maps.google.com/maps?q='+ $("#adresse").val()+'"> <img src="https://maps.googleapis.com/maps/api/staticmap?center='+$("#adresse").val()+ ',CA&zoom=13&size=400x400&KEY=AIzaSyChRJ1RFZ9U2fGWzhrZyS3GpNNF8DWz8TU"/></a> <br></br>'
